...
void main(List<String> arguments) async {
  ...
  log('==== Find items in the Meeting Room ====');
  ...
  log('==== Find all electronic devices ====');
  for (final Map<String, dynamic> item in _listOfJson) {
  ...
  log('==== Find all items were purchased on 16 Januari 2020 ====');
  for (final Map<String, dynamic> item in _listOfJson) {
    final _date =
  ...
  log('==== Find all items with brown color ====');
  for (final Map<String, dynamic> item in _listOfJson) {
